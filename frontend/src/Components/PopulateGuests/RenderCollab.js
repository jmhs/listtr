...
import './RenderCollab.css'
// import {updateGuestInfoToStore} from '../../Actions/Event'
class RenderCollab extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(RenderCollab);//to include guest population
