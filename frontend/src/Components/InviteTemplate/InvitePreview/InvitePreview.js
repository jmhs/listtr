...
export default class InvitePreview extends React.Component {
  constructor(props) {
    super(props);
  }
                          ...
                          <tbody><tr>
                              <td style={{paddingTop: 0, paddingBottom: 0, paddingRight: 0, paddingLeft: 0}}>{/* ======= start header ======= */}
                                ...
                                <table className="one-column" border={0} cellPadding={0} cellSpacing={0} width="100%" style={{borderSpacing: 0, borderLeft: '1px solid #e8e7e5', borderRight: '1px solid #e8e7e5', borderBottom: '1px solid #e8e7e5'}} bgcolor="#FFFFFF">
                                  <tbody><tr>
                                      <td align="center" style={{padding: '40px 40px 60px 40px'}}><p style={{color: '#262626', fontSize: 32, textAlign: 'center', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 2.5}}><strong>Title of Event</strong></p>

                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event Location:</strong> 'this.event.location' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event Dress Code:</strong> 'this.event.dressCode' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event Type:</strong> 'this.event.type' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event Start Date:</strong> 'this.event.startDate' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event End Date:</strong> 'this.event.endDate' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event Start Time:</strong> 'this.event.timeStart' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1}}><strong>Event End Time:</strong> 'this.event.timeEnd' </p>
                                        <p style={{color: '#000000', fontSize: 16, textAlign: 'left', fontFamily: 'Verdana, Geneva, sans-serif', lineHeight: 1, paddingTop: 20}}><strong>Description:</strong><br/><br/> 'this.event.description' </p>
                                        {/* START BUTTON */}
                                        <center>
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        <td align="center"><table border={0} cellPadding={0} cellSpacing={0} style={{margin: '0 auto'}}>
                                                            <tbody><tr>
                                                                <td width={250} height={60} align="center" bgcolor="#2f9780" style={{MozBorderRadius: 30, WebkitBorderRadius: 30, borderRadius: 30}}><a href="#" style={{width: 250, display: 'block', textDecoration: 'none', border: 0, textAlign: 'center',
                                                                fontWeight: 'bold', fontSize: 18, fontFamily: 'Arial, sans-serif', color: '#2f9780'}} className="button_link">
                                                                Click here to RSVP!<img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/73ac4376-78ab-4d32-a0b5-b8195202e51f.jpg" width={28} height={17} style={{paddingTop: 0, paddingLeft: 10}} alt border={0} /></a></td>
                                                              </tr>
                                                            </tbody></table></td>
                                                      </tr>
                                                    </tbody>
